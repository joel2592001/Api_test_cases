...
headings = ['Api_Name','Testcase_No','Email_input','Status']

with open('options_result.csv', 'w', newline='') as file:
...
try:
    ...
    r = requests.post('http://localhost:8888/options',data=json.dumps(val),headers=header)
